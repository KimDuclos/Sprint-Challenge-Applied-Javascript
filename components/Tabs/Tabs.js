class TabLink {
  constructor(tabElement){
    ...
    // We need to find out if a user clicked 'all' cards or a specific category.  Follow the instructions below 
    ...
    /*
     ...
     this.cards = Array.from(this.cards).map(cardElem => {
      return new TabCard(cardElem);
     });
